...
function FAQ() {
  return (
    <section className="bg-black dark:bg-black text-white dark:text-white">
      <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
        ...
        <div className="space-y-4">
          <details className="w-full border rounded-lg">
            <summary className="px-4 py-6 focus:outline-none focus-visible:ring-coral focus-visible:dark:ring-coral">
              Ex orci laoreet egestas sapien magna egestas scelerisque?
            </summary>
            <p className="px-4 py-6 pt-0 ml-4 -mt-4 text-white dark:text-white">
